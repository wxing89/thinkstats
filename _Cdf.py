...
class Cdf(object):
	...
	def Append(self, x, p):
		...
		Note: this us normally used to build a CDF from scrath, not
	...
	def _Round(self, multiplier=1000.0):
		...
		from the pervious value in a significant digit, where the number
...
def MakeCdfFromDict(d, name=''):
	'''Makes a CDF from a dictionary that maps values to frequecies.

	Args:
		d: dictionary that maps values to frequecies.
