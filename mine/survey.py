    ...
    def MakeRecord(self, line, fields, constructor):
        ...
        for (field, start, end, cast) in fields:
            try:
                ...
                val = 'NA'
            # you cannot use obj.__setattr__(attr, value) instead of 
            # setattr(obj, value, name) because the former function is 
...
class Pregnancies(Table):
    ...
    def Recode(self):
        for rec in self.records:
            ...
            # convert weight at birth from lbs/oz on total ounces
